...
const settingObj = {
  "0" : {
    image: 'https://assets.codepen.io/122136/dog-photo.jpg',
    depth: 'https://assets.codepen.io/122136/dog-depth-map.jpg',
    xThreshold: 15,
    yThreshold: 10,
  },
  "1" : {
    image: 'https://assets.codepen.io/122136/girl-photo.jpg',
    depth: 'https://assets.codepen.io/122136/girl-depth-map.jpg',
    xThreshold: 15,
    yThreshold: 10,
  },
  "2" : {
    image: 'https://assets.codepen.io/122136/splash-photo.jpg',
    depth: 'https://assets.codepen.io/122136/splash-depth-map-v1.jpg',
    xThreshold: 15,
    yThreshold: 10,
  }
}
...
// showSlide(currentIndex);
// console.log(settingObj, settingObj[current].image,loadImages);
// prevButton.addEventListener('click',()=>{
//   loadSettings(current);
// });
function loadSettings(current) {
  settings = {
    xThreshold: settingObj[current].xThreshold,
    yThreshold: settingObj[current].xThreshold,
    originalImagePath: settingObj[current].image,
    depthImagePath: settingObj[current].depth,
  }
  loadImages(settings);
}
/**
...
window.addEventListener("deviceorientation",(event)=> {
  ...
  cursor.x = alpha / sizes.height * gamma * .5
  cursor.y = beta / sizes.width * gamma * .5
});
